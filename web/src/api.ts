...
const NICE: Record<string, string> = {
  ...
  verification_pending: "Some answers were flagged by verification. Fix or dismiss each flag before publishing.",
  verification_not_found: "That verification flag was not found.",
  regenerating: "Regenerating.",
  already_regenerating: "Already regenerating.",
  lesson_not_found: "That lesson was not found.",
  ocr_not_configured: "Photo reading needs a vision model. Set AI_VISION_MODEL on the server (e.g. gpt-4o-mini) and try again. You can still paste the text by hand.",
  ocr_failed: "Could not read that photo. Try a clearer shot, or paste the text by hand.",
  ocr_empty: "No questions were readable in that photo. Try a closer crop, or paste the text.",
  upload_invalid: "That upload did not look right. Try the photo again.",
